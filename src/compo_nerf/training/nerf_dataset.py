...
class NeRFDataset:
    def __init__(self, cfg: RenderConfig, device, type='train', H=256, W=256, size=100):
        ...
        self.H = H
        self.W = W
        self.train_radius_range = cfg.radius_range
        self.test_radius_range = np.array(cfg.radius_range)*cfg.test_box_scale
    ...
    def collate(self, index):
        ...
        if self.training:
            ...
            poses, dirs = rand_poses(B, self.device, radius_range=self.train_radius_range,
